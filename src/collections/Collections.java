...
public class Collections {
    ...
    private void arrayListDemo() {
        ...
        friendList.add(1, "Kevin"); // The '1' indicates that this item will be added to the 2nd position
        ...
        boolean checkEnemyList = enemyList.isEmpty();
        
        System.out.println("Friend list is empty: " + checkFriendList);
        System.out.println("Enemy list is empty: " + checkEnemyList);
        
        // Check if a name is in the list
        System.out.println("Test 3: Checking if a name exists in an ArrayList");
        
        boolean containsJasmine = friendList.contains("Jasmine");
        boolean containsJacob = friendList.contains("Jacob");
        
        System.out.println("Jasmine is in friend list: " + containsJasmine);
        System.out.println("Jacob is in friend list: " + containsJacob);
        ...
        friendList.remove("Jonathan");
        friendList.remove("Jacob");
